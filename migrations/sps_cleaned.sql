...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`farm` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4generalci */;

USE `farm`;

/* Function  structure for function  `fn_generateanimaltag` */

/*!50003 DROP FUNCTION IF EXISTS `fn_generateanimaltag` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fngenerateanimaltag`() RETURNS varchar(50) CHARSET utf8mb4 COLLATE utf8mb4generalci
    READS SQL DATA
BEGIN
    DECLARE $prefix VARCHAR(50);
    DECLARE $currentno INT;
    DECLARE $formattedno VARCHAR(50);
    DECLARE $year VARCHAR(4);
    DECLARE $finalprefix VARCHAR(50);

    SELECT `prefix`, `currentno` INTO $prefix, $currentno 
    FROM `serials` WHERE `document` = 'Animal Tag';
    
    SET $year = YEAR(CURDATE());
    SET $finalprefix = REPLACE($prefix, '{{year}}', $year);

    SET $formattedno = LPAD($currentno, 5, '0');
    
    RETURN CONCAT($finalprefix, $formattedno);
END */$$
DELIMITER ;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fngeneratesupplierno`() RETURNS varchar(50) CHARSET utf8mb4 COLLATE utf8mb4generalci
    READS SQL DATA
BEGIN
    DECLARE $prefix VARCHAR(50);
    DECLARE $currentno INT;
    ...
    SET $formattedno = LPAD($currentno, 4, '0');
...
/*!50003 DROP PROCEDURE IF EXISTS  `spcheckifbreedexists` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spcheckifbreedexists`(
    IN `$id` INT, 
...
/*!50003 DROP PROCEDURE IF EXISTS  `spdeletebreed` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spdeletebreed`(
    IN `$id` INT,
    IN `$userid` INT,
    IN `$reason` TEXT,
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetbreeddetails` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetbreeddetails`(
    IN `$id` INT
)
BEGIN
    SELECT 
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetbreeds` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetbreeds`()
BEGIN
    SELECT 
        b.*, 
        c.`countryname`, 
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsavebreed` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsavebreed`(
    IN `$id` INT,
    IN `$breedname` VARCHAR(100),
    IN `$originid` INT,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spchangeuserpassword`($id numeric, $userpassword varchar(100),$salt varchar(50),$changepasswordonlogon bool)
BEGIN
	update `user` 
...
/*!50003 DROP PROCEDURE IF EXISTS  `spcheckanimaldetails` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spcheckanimaldetails`(
    IN `$id` INT,
...
/*!50003 DROP PROCEDURE IF EXISTS  `spcheckifanimalexists` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spcheckifanimalexists`(
    IN `$id` INT, 
    IN `$tagid` VARCHAR(50),
...
/*!50003 DROP PROCEDURE IF EXISTS  `spcheckifcountryexists` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spcheckifcountryexists`(
    IN `$id` INT, 
...
/*!50003 DROP PROCEDURE IF EXISTS  `spcheckifdiseaseexists` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spcheckifdiseaseexists`(
    IN `$id` INT, 
...
/*!50003 DROP PROCEDURE IF EXISTS  `spcheckifemployeeisystemuser` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spcheckifemployeeisystemuser`($staffno varchar(100))
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spcheckifpenexists` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spcheckifpenexists`(
    IN `$id` INT,
...
/*!50003 DROP PROCEDURE IF EXISTS  `spcheckuserovertimeapprovalprivilege` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spcheckuserovertimeapprovalprivilege`($userid int,$levelid int,$unitid int)
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spcreateemployeeuseraccount` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spcreateemployeeuseraccount`($staffno varchar(50),$mobile varchar(50),$emailaddress varchar(50),$salt varchar(50),
...
/*!50003 DROP PROCEDURE IF EXISTS  `spdeleteanimal` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spdeleteanimal`(
    IN `$id` INT,
    IN `$userid` INT,
    IN `$reason` TEXT,
    IN `$platform` VARCHAR(1000)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spdeletecountry`(
    IN `$id` INT,
    IN `$userid` INT,
    IN `$reason` TEXT,
    IN `$platform` VARCHAR(1000)
...
/*!50003 DROP PROCEDURE IF EXISTS  `spdeletedisease` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spdeletedisease`(
    IN `$id` INT,
    IN `$userid` INT,
    IN `$reason` TEXT,
    IN `$platform` VARCHAR(1000)
...
/*!50003 DROP PROCEDURE IF EXISTS  `spdeleteinventorycategory` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spdeleteinventorycategory`(
    IN `$id` INT,
    IN `$userid` INT,
    IN `$platform` VARCHAR(1000)
)
BEGIN
    ...
    SELECT `categoryname`, JSONOBJECT('id', `id`, 'categoryname', `categoryname`) INTO `$categoryname`, `$originalvalues`
...
/*!50003 DROP PROCEDURE IF EXISTS  `spdeleteinventoryitem` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spdeleteinventoryitem`(
    IN `$id` INT,
    IN `$userid` INT,
    IN `$platform` VARCHAR(1000)
)
BEGIN
    ...
    SELECT `itemname`, JSONOBJECT('id', `id`, 'itemname', `itemname`) INTO `$itemname`, `$originalvalues`
...
/*!50003 DROP PROCEDURE IF EXISTS  `spdeleteinventoryreceipt` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spdeleteinventoryreceipt`(
    IN `$id` INT,
    IN `$userid` INT,
    IN `$platform` VARCHAR(1000)
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spdeletesupplier`(
    IN `$id` INT,
    IN `$userid` INT,
    IN `$platform` VARCHAR(1000)
)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spdeleteuser`(`$id` INT, `$userid` INT)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spdisableuseraccount`(`$id` INT, `$reason` VARCHAR(500), `$userid` INT,$platform varchar(1000))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spenableuseraccount`(`$id` INT,`$userid` INT,$platform varchar(1000))
BEGIN
	declare $username varchar(100);
	declare $fullname varchar(100);
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetallsettings` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetallsettings`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetallusers`()
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetanimaldetails` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetanimaldetails`(
    IN `$id` INT
)
BEGIN
    SELECT 
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetanimals` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetanimals`()
BEGIN
    SELECT 
        a.*, 
        b.`breedname`, 
...
BEGIN
    ...
    LEFT JOIN (
        ...
        WHERE mc.`deleted` = 0 AND mc.`logdate` >= DATESUB(CURDATE(), INTERVAL 30 DAY)
        GROUP BY a.`breedid`
    ) m ON b.`id` = m.`breedid`
    -- Health Join
    LEFT JOIN (
        ...
        FROM `animals` a
        LEFT JOIN `healthlogs` hl ON a.`id` = hl.`animalid` AND hl.`deleted` = 0 AND hl.`logdate` >= DATESUB(CURDATE(), INTERVAL 30 DAY)
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetcategorysummaries` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetcategorysummaries`()
BEGIN
    SELECT 
        ic.id,
        ic.categoryname,
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetcompanydetails` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetcompanydetails`()
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetcountries`()
BEGIN
    SELECT 
        c.*, 
        CONCAT(u.`firstname`, ' ', u.`lastname`) AS `addedbyname`
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetcountrydetails` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetcountrydetails`(
    IN `$id` INT
)
BEGIN
    SELECT 
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetdiseasedetails` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetdiseasedetails`(
    IN `$id` INT
)
BEGIN
    SELECT 
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetdiseases` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetdiseases`()
BEGIN
    SELECT 
        d.*, 
        CONCAT(u.`firstname`, ' ', u.`lastname`) AS `addedbyname`
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetemailsettings` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetemailsettings`()
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetemailsettingsbyrole` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetemailsettingsbyrole`(
    IN `$role` VARCHAR(100)
)
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetinbuiltsystemuser` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetinbuiltsystemuser`()
BEGIN
		select * from `user`
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetinventorycategories` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetinventorycategories`(
    IN `$id` INT
)
BEGIN
    IF `$id` = 0 THEN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetinventorycategorysummaries` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetinventorycategorysummaries`()
BEGIN
    SELECT 
        ic.id,
        ic.categoryname,
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetinventoryitems` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetinventoryitems`(
    IN `$categoryid` INT,
    IN `$itemid` INT
)
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetinventoryreceiptdetails` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetinventoryreceiptdetails`(
    IN `$receiptid` INT
)
BEGIN
    SELECT 
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetinventoryreceipts` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetinventoryreceipts`(
    IN `$id` INT
)
BEGIN
    IF `$id` = 0 THEN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetinventorystats` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetinventorystats`()
BEGIN
    SELECT 
        IFNULL(SUM(currentstock * unitprice), 0) AS totalvalue,
        COUNT(CASE WHEN currentstock <= reorderlevel AND deleted = 0 THEN 1 END) AS lowstockcount,
        (SELECT COUNT(*) FROM inventorycategories WHERE deleted = 0) AS categorycount
    FROM inventoryitems
    WHERE deleted = 0;
END */$$
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetmilkcollection` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetmilkcollection`(
    IN `$startdate` DATE,
    IN `$enddate` DATE,
    IN `$scheduleid` INT
)
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetpendingemails` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetpendingemails`()
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetpens` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetpens`()
BEGIN
    SELECT 
        p.*,
        (SELECT COUNT(*) FROM `animals` a WHERE a.`penid` = p.`id` AND a.`deleted` = 0) as currentoccupancy
    FROM `pens` p
    WHERE p.`deleted` = 0;
END */$$
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetproductionstats` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetproductionstats`(
    IN `$logdate` DATE
)
BEGIN
    DECLARE `$yesterday` DATE;
    SET `$yesterday` = DATESUB(`$logdate`, INTERVAL 1 DAY);
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetproductiontrends` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetproductiontrends`(
    IN `$enddate` DATE
)
BEGIN
    SELECT 
    ...
    FROM (
        ...
        SELECT DATESUB(CURDATE(), INTERVAL 1 DAY) UNION ALL
        SELECT DATESUB(CURDATE(), INTERVAL 2 DAY) UNION ALL
        SELECT DATESUB(CURDATE(), INTERVAL 3 DAY) UNION ALL
        SELECT DATESUB(CURDATE(), INTERVAL 4 DAY) UNION ALL
        SELECT DATESUB(CURDATE(), INTERVAL 5 DAY) UNION ALL
        SELECT DATESUB(CURDATE(), INTERVAL 6 DAY)
    ) d
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetrecentemaillogs` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetrecentemaillogs`()
BEGIN
    SELECT 
        `id`, 
        `sender`, 
        ...
        DATEFORMAT(`dateadded`, '%H:%i') as `timeadded`
    FROM `emaillogs`
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetrecentsmslogs` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetrecentsmslogs`()
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetsmsproviders` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetsmsproviders`()
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetsmssettings` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetsmssettings`(
    IN `$id` INT
)
BEGIN
    IF `$id` = 0 THEN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetsuppliers`(
    IN `$id` INT
)
BEGIN
    IF `$id` = 0 THEN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetuserbyid`(`$userid` INT)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetuserdetails`(`$username` VARCHAR(50))
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetuserdetailsbyusername` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetuserdetailsbyusername`($username varchar(100))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetusernamefromuserid`(`$userid` INT)
BEGIN
	select * from `user` where `userid`=$userid;
    END */$$
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetuserovertimeapprovalprivileges` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetuserovertimeapprovalprivileges`($userid int)
BEGIN
		select * from `overtimeapprovalusers`
...
/*!50003 DROP PROCEDURE IF EXISTS  `spgetuserrecruitmentprivileges` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetuserrecruitmentprivileges`($userid int)
BEGIN
		select * 
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spgetuserunits`($userid int)
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spremoveusercompany` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spremoveusercompany`($userunitid int, $addedby int,$platform varchar(1000))
BEGIN
		declare $userid int;
		declare $username varchar(100);
		declare $unitid int;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spremoveuserrole`($userroleid int,$userid int,$platform varchar(1000))
BEGIN
		start transaction;
			update `roleusers`
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsaveanimal` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveanimal`(
    IN `$id` INT,
    IN `$tagid` VARCHAR(50),
    IN `$designatedname` VARCHAR(100),
    IN `$breedid` INT,
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsavecompanydetails` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsavecompanydetails`(
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsavecountry`(
    IN `$id` INT,
    IN `$countryname` VARCHAR(100),
    IN `$userid` INT,
    IN `$platform` VARCHAR(1000)
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsavedisease` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsavedisease`(
    IN `$id` INT,
    IN `$diseasename` VARCHAR(100),
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsaveemaillog` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveemaillog`(
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsaveemailsettings` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveemailsettings`(
    IN `$id` INT,
    IN `$role` VARCHAR(100),
...
BEGIN
    ...
    IF `$id` = 0 THEN
        ...
        SET `$updatedvalues` = JSONOBJECT('id', `$id`, 'role', `$role`, 'useremail', `$useremail`);
    ...
    ELSE
        SELECT JSONOBJECT('role', `role`, 'useremail', `useremail`) INTO `$originalvalues` 
        ...
        SELECT JSONOBJECT('role', `role`, 'useremail', `useremail`) INTO `$updatedvalues` 
        FROM `emailsettings` WHERE `id` = `$id`;
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsaveinventorycategory` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveinventorycategory`(
    IN `$id` INT,
...
BEGIN
    ...
    IF `$id` = 0 THEN
        ...
        SET `$updatedvalues` = JSONOBJECT('id', `$id`, 'categorycode', `$categorycode`, 'categoryname', `$categoryname`);
        
        INSERT INTO `audittrail` (`timestamp`, `userid`, `operation`, `narration`, `platform`, `updatedvalues`)
        VALUES (NOW(), `$userid`, 'Insert', CONCAT('Created Inventory Category: ', `$categoryname`), `$platform`, `$updatedvalues`);
    ELSE
        SELECT JSONOBJECT('categorycode', `categorycode`, 'categoryname', `categoryname`) INTO `$originalvalues` 
        FROM `inventorycategories` WHERE `id` = `$id`;
        ...
        SELECT JSONOBJECT('categorycode', `categorycode`, 'categoryname', `categoryname`) INTO `$updatedvalues` 
        FROM `inventorycategories` WHERE `id` = `$id`;
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsaveinventoryitem` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveinventoryitem`(
    IN `$id` INT,
    IN `$categoryid` INT,
...
BEGIN
    ...
    IF `$id` = 0 THEN
        ...
        SET `$updatedvalues` = JSONOBJECT('id', `$id`, 'itemcode', `$itemcode`, 'itemname', `$itemname`);
        
        INSERT INTO `audittrail` (`timestamp`, `userid`, `operation`, `narration`, `platform`, `updatedvalues`)
        VALUES (NOW(), `$userid`, 'Insert', CONCAT('Provisioned Inventory Item: ', `$itemname`), `$platform`, `$updatedvalues`);
    ELSE
        SELECT JSONOBJECT('itemcode', `itemcode`, 'itemname', `itemname`) INTO `$originalvalues` 
        FROM `inventoryitems` WHERE `id` = `$id`;
        ...
        SELECT JSONOBJECT('itemcode', `itemcode`, 'itemname', `itemname`) INTO `$updatedvalues` 
        FROM `inventoryitems` WHERE `id` = `$id`;
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsaveinventoryreceipt` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveinventoryreceipt`(
    IN `$id` INT,
...
BEGIN
    ...
    IF `$id` = 0 THEN
        ...
        IF `$receiptno` = '' OR `$receiptno` IS NULL THEN
            SET `$receiptno` = CONCAT('REC-', DATEFORMAT(NOW(), '%y%m%d'), '-', LPAD((SELECT COUNT(*) + 1 FROM `inventoryreceipts`), 4, '0'));
        END IF;
        ...
        SET `$updatedvalues` = JSONOBJECT('id', `$id`, 'receiptno', `$receiptno`, 'supplierid', `$supplierid`);
        
        INSERT INTO `audittrail` (`timestamp`, `userid`, `operation`, `narration`, `platform`, `updatedvalues`)
        VALUES (NOW(), `$userid`, 'Insert', CONCAT('Created Inventory Receipt: ', `$receiptno`), `$platform`, `$updatedvalues`);
    ELSE
        SELECT JSONOBJECT('receiptno', `receiptno`, 'status', `status`) INTO `$originalvalues` 
        ...
        SELECT JSONOBJECT('receiptno', `receiptno`, 'status', `status`) INTO `$updatedvalues` 
        FROM `inventoryreceipts` WHERE `id` = `$id`;
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsaveinventoryreceiptdetail` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveinventoryreceiptdetail`(
    IN `$receiptid` INT,
    IN `$itemid` INT,
...
BEGIN
    ...
    SELECT LASTINSERTID() AS `detailid`;
END */$$
DELIMITER ;

/* Procedure structure for procedure `spsavemilkcollection` */

/*!50003 DROP PROCEDURE IF EXISTS  `spsavemilkcollection` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsavemilkcollection`(
    IN `$id` INT,
    IN `$logdate` DATE,
    IN `$scheduleid` INT,
    IN `$animalid` INT,
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsavepen` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsavepen`(
    IN `$id` INT,
    IN `$penname` VARCHAR(100),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveroleusers`(`$userid` INT, `$roleid` INT, `$addedby` INT)
BEGIN
	declare $userbac int;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsavesmslog`(
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsavesmssettings` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsavesmssettings`(
    IN `$id` INT,
...
BEGIN
    ...
    IF `$id` = 0 THEN
        ...
        SET `$updatedvalues` = JSONOBJECT('id', `$id`, 'provider', `$providername`, 'isdefault', `$isdefault`);
        
        INSERT INTO `audittrail` (`timestamp`, `userid`, `operation`, `narration`, `platform`, `updatedvalues`)
        VALUES (NOW(), `$userid`, 'Insert', CONCAT('Created SMS Settings for: ', `$providername`), `$platform`, `$updatedvalues`);
    ELSE
        SELECT JSONOBJECT('providername', `providername`, 'isdefault', `isdefault`) INTO `$originalvalues` 
        ...
        SELECT JSONOBJECT('providername', `providername`, 'isdefault', `isdefault`) INTO `$updatedvalues` 
        FROM `smssettings` WHERE `id` = `$id`;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsavesupplier`(
    IN `$id` INT,
    IN `$code` VARCHAR(50),
    IN `$name` VARCHAR(255),
...
BEGIN
    ...
    IF `$id` = 0 THEN
        ...
        SET `$updatedvalues` = JSONOBJECT('id', `$id`, 'suppliername', `$name`, 'mobile', `$mobile`);
        
        INSERT INTO `audittrail` (`timestamp`, `userid`, `operation`, `narration`, `platform`, `updatedvalues`)
        VALUES (NOW(), `$userid`, 'Insert', CONCAT('Created Supplier: ', `$name`), `$platform`, `$updatedvalues`);
    ELSE
        SELECT JSONOBJECT('suppliername', `suppliername`, 'mobile', `mobile`) INTO `$originalvalues` 
        ...
        SELECT JSONOBJECT('suppliername', `suppliername`, 'mobile', `mobile`) INTO `$updatedvalues` 
        FROM `suppliers` WHERE `id` = `$id`;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveuser`(`$userid` INT, `$userpassword` VARCHAR(100),$salt varchar(50),`$roleid` int, `$username` VARCHAR(50), `$firstname` VARCHAR(50), `$middlename` VARCHAR(50), `$lastname` VARCHAR(50), `$email` VARCHAR(50), `$mobile` VARCHAR(50), 
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveuserprivilege`(`$userid` INT, `$objectid` INT, `$allowed` BIT, `$useradding` INT)
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spsaveuserunit` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spsaveuserunit`($userid int,$unitid int,$allowed bool,$addedby int,$platform varchar(1000))
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS  `spupdateemailstatus` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spupdateemailstatus`(
    IN `$id` INT,
...
/*!50003 DROP PROCEDURE IF EXISTS  `spupdatesmsreadstatus` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spupdatesmsreadstatus`(
    IN `$id` INT,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spupdatesmsstatus`(
    IN `$id` INT,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spvalidateuserprivilege`(`$userid` INT, `$objectcode` varchar(50))
BEGIN
	declare $admin int;
...
/*!40101 SET SQLMODE=@OLDSQLMODE */;
/*!40014 SET FOREIGNKEYCHECKS=@OLDFOREIGNKEYCHECKS */;
/*!40014 SET UNIQUECHECKS=@OLDUNIQUECHECKS */;
/*!40111 SET SQLNOTES=@OLDSQLNOTES */;
