<?php
/**
 * Jukam Dairy Management System - Health Records Report (View/Print)
 * File: views/health_records_report.php
 */
$base_path = '../';
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Health Records Report | Jukam Farm</title>
    ...
    <style>
        ...
        /* Responsive Mobile Overrides (Parity with Production Report) */
...
<body class="bg-background">
    ...
    <main class="main-content">
        <div class="container-fluid pt-1 px-4">
            ...
            <div class="no-print report-controls-row d-flex justify-content-between align-items-center mb-4 mt-1">
                ...
                <div class="d-flex align-items-center">
                    <button class="btn-report-outline mr-3" onclick="window.print()">
                        Print
                    </button>
                    <div class="dropdown">
            ...
            <div class="report-document-surface">
                ...
                <div class="row mb-4 pb-3 border-bottom">
                    <div class="col-md-8">
                        <span class="report-header-badge d-block mb-1">Health Performance Audit</span>
                        <h1 class="font-headline font-weight-bold text-on-surface mb-2 report-title-main" style="font-size: 1.4rem;">Herd Health Report</h1>
                    ...
                    <div class="col-md-4 text-md-right mt-4 mt-md-0">
                        ...
                        <h4 class="font-headline font-weight-bold text-primary mb-0" style="font-size: 1.1rem; color: var(--primary) !important;">Jukam Dairy Farm</h4>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-6 col-md-3">
                        <div class="bento-stat-card primary-border h-100">
                            <p class="stat-label">Total Treatments</p>
                            <div>
                                <h3 class="stat-value mb-0">142</h3>
                                <div class="stat-trend trend-up">
                                    <span class="material-symbols-outlined" style="font-size: 0.8rem;">healing</span>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="bento-stat-card h-100">
                            <p class="stat-label">Active Vaccinations</p>
                            <div>
                                <h3 class="stat-value mb-0">285</h3>
                                <div class="stat-trend trend-neutral">
                                    <span class="material-symbols-outlined" style="font-size: 0.8rem;">vaccines</span>
                    ...
                    <div class="col-6 col-md-3 mt-3 mt-md-0">
                        <div class="bento-stat-card h-100">
                            <p class="stat-label">Deworming Comp.</p>
                            <div>
                                <h3 class="stat-value mb-0">92.4 <span class="stat-unit">%</span></h3>
                                <div class="progress mt-2" style="height: 3px; background: #f0f0f0;">
                    ...
                    <div class="col-6 col-md-3 mt-3 mt-md-0">
                        <div class="bento-stat-card h-100">
                            <p class="stat-label">Herd Wellness</p>
                            <div>
                                <h3 class="stat-value mb-0">88 <span class="stat-unit">/100</span></h3>
                                <span class="badge badge-success mt-2" style="font-size: 0.55rem; padding: 0.35rem 0.5rem; background-color: var(--primary);">EXCELLENT STATUS</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="report-table-container">
                    <div class="report-table-header">
                        <h5 class="mb-0 font-weight-bold font-headline" style="font-size: 0.85rem;">Detailed Health Log</h5>
                        <span class="stat-label mb-0">October 2023 Period</span>
                    </div>
                        ...
                        <table class="table report-printable-table mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="d-none d-md-table-cell">Treatment/Medication</th>
                                    <th class="text-primary font-weight-bold" style="color: var(--primary) !important;">Status</th>
                                    <th class="d-none d-md-table-cell">Vet/Attendant</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="font-weight-bold" style="font-size: 0.75rem;">Oct 24, 2023</td>
                                    <td class="text-primary font-weight-bold">JK-4421</td>
                                    <td>Mastitis (Sub-clinical)</td>
                                    <td class="d-none d-md-table-cell italic">Cloxacillin Intramammary</td>
                                    <td><span class="badge badge-pill badge-warning-subtle" style="background: rgba(121, 89, 0, 0.1); color: #795900; font-size: 0.65rem; font-weight: 700;">ONGOING</span></td>
                                    <td class="d-none d-md-table-cell">Dr. Benson K.</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold" style="font-size: 0.75rem;">Oct 22, 2023</td>
                                    <td class="text-primary font-weight-bold">JK-5098</td>
                                    <td>Hoof Rot</td>
                                    <td class="d-none d-md-table-cell italic">Copper Sulfate Footbath</td>
                                    <td><span class="badge badge-pill badge-primary-subtle" style="background: rgba(32, 98, 35, 0.1); color: var(--primary); font-size: 0.65rem; font-weight: 700;">RECOVERED</span></td>
                                    <td class="d-none d-md-table-cell">Vet Tech Sarah</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold" style="font-size: 0.75rem;">Oct 20, 2023</td>
                                    <td class="text-primary font-weight-bold">JK-1120</td>
                                    <td>Milk Fever</td>
                                    <td class="d-none d-md-table-cell italic">Calcium Gluconate IV</td>
                                    <td><span class="badge badge-pill badge-primary-subtle" style="background: rgba(32, 98, 35, 0.1); color: var(--primary); font-size: 0.65rem; font-weight: 700;">RECOVERED</span></td>
                                    <td class="d-none d-md-table-cell">Dr. Benson K.</td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold" style="font-size: 0.75rem;">Oct 18, 2023</td>
                                    <td class="text-primary font-weight-bold">JK-3321</td>
                                    <td>Bovine Respiratory</td>
                                    <td class="d-none d-md-table-cell italic">Tylosin injection</td>
                                    <td><span class="badge badge-pill badge-warning-subtle" style="background: rgba(121, 89, 0, 0.1); color: #795900; font-size: 0.65rem; font-weight: 700;">ONGOING</span></td>
                                    <td class="d-none d-md-table-cell">Dr. Emily Chen</td>
                                </tr>
                            </tbody>
                            <tfoot class="bg-surface-container-low/30" style="border-top: 2px solid var(--report-card-border);">
                                <tr class="font-weight-bold" style="font-size: 0.8rem;">
                                    <td class="py-3 px-6">Monthly Summary</td>
                                    <td class="py-3 px-6 d-none d-md-table-cell" colspan="2">Total Cases: 142</td>
                                    <td class="py-3 px-6 text-primary" style="color: var(--primary) !important;">94.2% Success</td>
                                    <td class="py-3 px-6 d-none d-md-table-cell text-muted font-weight-medium">Audit Verified</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                ...
                <div class="report-footer">
                    <div class="mobile-metadata-hide">
                        ...
                        <p class="mb-0 text-muted uppercase tracking-widest" style="font-size: 0.6rem;">Generated on Oct 31, 2023 | Page 1 of 5 | Ref: HR-202310-042</p>
                    </div>
